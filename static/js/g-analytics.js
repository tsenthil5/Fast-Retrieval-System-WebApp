...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('submit-text').addEventListener('click', function(event) {
        ...
        document.getElementById('text-search').style.display = 'block'; // Show the text search form
    ...
    document.getElementById('submit-Image').addEventListener('click', function(event) {
        event.preventDefault();  // Prevent form submission
        document.getElementById('text-search').style.display = 'none';  // Hide the text search form
